...
const METRIC_QUERIES = {
  android_anr: `SELECT * FROM android_anr LIMIT 1000`,
  android_jank: `SELECT * FROM android_jank LIMIT 1000`,
  android_startup: `SELECT * FROM android_startup LIMIT 1000`,
};

type PageView = 'bigtrace' | 'android_anr' | 'android_jank' | 'android_startup';

class BigTraceApp implements m.ClassComponent {
  private sidebarVisible = true;
  private currentPage: PageView = 'bigtrace';
